...
import CabinSketchRegularTTF from '../assets/fonts/CabinSketch-Regular.ttf';
...
const GlobalStyles = createGlobalStyle`
  ...
  *, *::before, *::after {
  ...
  body {
    ...
    position: relative;
    min-height: 100vh;
    overflow-x: hidden; /* Garde ceci si vous voulez éviter un scroll horizontal */
    ...
    /* --- MODIFICATION ICI : On enlève le filtre et transition car ils sont gérés par JS maintenant --- */
